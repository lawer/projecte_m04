  ...
  function repeatable(el) {
    ...
    function replace(text, data) {
      function subst(a, b) {
        ...
        var s = expr.call(data, index, index == 0, index == vector.length - 1, vector.length);
    ...
    try {
      Object.defineProperty(el, "value", {get: getValue, set: setValue, enumerable: true, configurable: true});
    } catch (e) {
    }
